...
In answering the question of whether a patient will have AD, in this project, we hope to adopt a data-driven method to make such predictions based on biomarkers as well as the results from typical diagnosis procedure results.
